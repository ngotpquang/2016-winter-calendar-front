...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs_add_observable_throw__ = __webpack_require__(708);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs_add_observable_throw___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_rxjs_add_observable_throw__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_add_operator_catch__ = __webpack_require__(709);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_add_operator_catch___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_rxjs_add_operator_catch__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_debounceTime__ = __webpack_require__(710);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_debounceTime___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_debounceTime__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_distinctUntilChanged__ = __webpack_require__(711);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_distinctUntilChanged___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_distinctUntilChanged__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map__ = __webpack_require__(712);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_switchMap__ = __webpack_require__(713);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_switchMap___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_switchMap__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_toPromise__ = __webpack_require__(714);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__user_user_service__ = __webpack_require__(56);
...
var CommonFunctions = (function () {
    ...
    CommonFunctions.prototype.sortGoals = function (goals, sortType) {
        switch (sortType) {
            ...
            case "3":
                return goals.sort(function (goal1, goal2) {
                    var att1 = goal1.start_date.split('T')[1];
                    var att2 = goal2.start_date.split('T')[1];
                    if (att1 < att2) {
                        return -1;
                    }
                    if (att1 > att2) {
    ...
    CommonFunctions.prototype.timeForReminder = function (time) {
        switch (time) {
            case '0': return "0";
            case '1': return "10";
            case '2': return "30";
    ...
    CommonFunctions.prototype.pushReminder = function (result, input) {
    ...
    CommonFunctions.prototype.formatStartDate = function (startDate) {
        var result = "";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_common_functions__ = __webpack_require__(19);
...
var MonthViewComponent = (function () {
    ...
    MonthViewComponent.prototype.navigateToYearView = function () {
        var year = document.getElementById('year');
        var fullYear = year.innerHTML;
    ...
    MonthViewComponent.prototype.displayDate = function (id) {
        ...
        if (this.goal.is_archived == true) {
            ...
            var date = document.getElementById(id + "");
            var monthName = document.getElementById('monthName');
            var month_1 = this.getMonth(monthName.innerHTML) + 1;
            var year_1 = document.getElementById('year');
            var fullDate_1 = year_1.innerHTML + "-" + month_1 + "-" + date.innerHTML;
                    ...
                    if (date.classList.item(1) == 'pass') {
                        ...
                        this.timeOut[id] = setTimeout(function () {
                            _this.goalService.markGoal(_this.goal.id, fullDate_1, "2").subscribe(function (res) {
                                ...
                                _this.goal = res.json();
                                _this.displayGoalInfor();
                                _this.router.navigate(["/monthview", _this.goal.id, year_1.innerHTML, month_1]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shared_common_functions__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__user_user_service__ = __webpack_require__(56);
...
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return ActiveAccountComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ActiveAccountComponent = (function () {
    function ActiveAccountComponent(http, route, router, userService) {
        this.http = http;
        this.route = route;
        this.router = router;
        this.userService = userService;
    ...
    ActiveAccountComponent.prototype.ngOnInit = function () {
        var _this = this;
        var token = this.route.params['_value']['token'];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_common_functions__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__user_user_service__ = __webpack_require__(56);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_common_functions__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__loading_indicator_loading_page__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_goal__ = __webpack_require__(339);
...
var CreateNewGoalComponent = (function (_super) {
    ...
    function CreateNewGoalComponent(goalService, router) {
        ...
        this.createNewGoalForm = new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["a" /* FormGroup */]({
            ...
            type_of_month: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* FormControl */]("1"),
            ...
            time_before_1: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* FormControl */](),
            time_before_2: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* FormControl */](),
            time_before_3: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* FormControl */](),
            time_before_4: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* FormControl */](),
            time_before_5: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* FormControl */](),
            time_before_1_t: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* FormControl */](),
            time_before_2_t: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* FormControl */](),
            time_before_3_t: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* FormControl */](),
            time_before_4_t: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* FormControl */](),
            time_before_5_t: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* FormControl */]()
        });
    }
    CreateNewGoalComponent.prototype.ngOnInit = function () {
        ...
        this.commonFunctions = new __WEBPACK_IMPORTED_MODULE_3__shared_common_functions__["a" /* CommonFunctions */]();
        var today = this.commonFunctions.roundUpTime();
    ...
    CreateNewGoalComponent.prototype.changeMonthlyType = function () {
        ...
        setTimeout(function () {
            var input = _this.createNewGoalForm.value;
            var startDate;
            if (isNaN(Date.parse(input.start_date))) {
                startDate = _this.roundUpTime();
            }
            else {
                ...
                if (startDate.getFullYear() > 2100) {
                    ...
                    startDate.setHours(_this.roundUpTime().getHours(), _this.roundUpTime().getMinutes(), 0, 0);
                }
            ...
            startDateInput.value = _this.commonFunctions.formatStartDate(startDate);
            _this.startTime = _this.commonFunctions.formatStartDate(startDate);
            console.log(_this.startTime);
            document.getElementById('dayDefineValue').innerHTML = _this.commonFunctions.getDay(startDate);
        }, 1000);
    };
    CreateNewGoalComponent.prototype.changeRepetitionLimitedTime = function () {
        this.commonFunctions.changeRepetitionLimitedTime();
    };
    CreateNewGoalComponent.prototype.resetInputFormControl = function (id) {
        var inputForm = this.createNewGoalForm.value;
        switch (id) {
            case 'time_before_1':
    ...
    CreateNewGoalComponent.prototype.showReminders = function (reminderId) {
        var inputForm = this.createNewGoalForm.value;
        var numOfRemindersShowed = 0;
        if (typeof (reminderId) == 'undefined') {
            var reminders = document.getElementsByClassName('reminder-group');
            var selects = document.getElementsByClassName('time-before');
            for (var reminder in reminders) {
                var element = reminders[reminder];
                if (element.hidden == true) {
                    element.hidden = false;
                    this.resetInputFormControl(element.getAttribute('id'));
                    selects[reminder].value = "";
                    break;
                }
            ...
            var select = document.getElementById('select-' + reminderId);
            var input = document.getElementById('input-' + reminderId);
            input.hidden = true;
            this.resetInputFormControl(reminderId);
            var reminders = document.getElementsByClassName('reminder-group');
            for (var reminder_1 in reminders) {
                var element = reminders[reminder_1];
    ...
    CreateNewGoalComponent.prototype.changeToSetTime = function (item) {
    ...
    CreateNewGoalComponent.prototype.addNewGoal = function () {
        ...
        if (input.goal_name != "") {
            ...
            var time_before = new Array();
            var timeBeforeGroup = new Array();
            for (var _i = 0, _a = this.timeBefores; _i < _a.length; _i++) {
                var time = _a[_i];
                timeBeforeGroup.push(document.getElementById(time));
            }
            ...
            var goal = new __WEBPACK_IMPORTED_MODULE_5__shared_goal__["a" /* Goal */](currentUser.email, currentUser.token, input.goal_name, this.startTime, input.description, new __WEBPACK_IMPORTED_MODULE_5__shared_goal__["b" /* Repetition */](input.type_of_repetition, input.how_often, day_of_week, input.type_of_month), new __WEBPACK_IMPORTED_MODULE_5__shared_goal__["c" /* EndDate */](input.type_of_end_date, specific_end_date, input.number_of_event), input.autoUpdateFailed, time_before.toString());
...
var EditGoalComponent = (function () {
    function EditGoalComponent(goalService, route, location, router) {
        ...
        this.reminderValues = [];
        this.reminderTypes = [];
        this.reminderLength = 0;
        this.defaultTime = '00:00';
        this.convertArray = ['0', '10', '30', '60', '120', '180', '720', '00:00'];
    }
    ;
    EditGoalComponent.prototype.ngOnInit = function () {
        ...
        this.goalService.getGoalsById(this.id).toPromise().then(function (data) {
            ...
            var fullTime = new Date(_this.goal.start_date).getTime();
            var temp = fullTime + (offSet * 60 * 1000);
            _this.goal.start_date = new Date(temp);
            ...
            _this.setDay();
            _this.setDate();
            var tmpString = _this.goal.time_before;
            if (tmpString !== '') {
                _this.reminderString = _this.goal.time_before;
                _this.stringToReminders();
            }
    ...
    EditGoalComponent.prototype.editGoal = function () {
        ...
        this.goalService.editGoal(this.id, this.goal).then(function () { return _this.router.navigate(['/detailview']); }).catch(function (error) {
            console.log(error);
        });
    };
    ...
    EditGoalComponent.prototype.checkNewEndDate = function (obj) {
        var endDate = new Date(obj.target.value);
        ...
        if (endDate.getTime() - startDate.getTime() < -(8.64e+7)) {
            ...
            document.getElementById('until-date').value = this.goal.end_date.specific_end_date;
            return;
        }
        else {
            return;
    ...
    EditGoalComponent.prototype.convertDate = function (date) {
        function pad(s) { return (s < 10) ? '0' + s : s; }
        var d = date;
        return [d.getFullYear(), pad(d.getMonth() + 1), pad(d.getDate())].join('-');
    };
    EditGoalComponent.prototype.addReminder = function () {
        this.reminders.push('reminder' + this.reminderLength);
        this.reminderTypes.push('');
        this.reminderValues.push('');
        this.reminderLength++;
    };
    EditGoalComponent.prototype.deleteReminder = function (name) {
        var index = this.reminders.indexOf(name);
        if (index > -1) {
    ...
    EditGoalComponent.prototype.setReminderValues = function (para1, para2) {
        var num = parseInt(para2, 10);
        this.reminderValues[para1] = this.convertArray[num];
        this.createTheUniqueArray();
    };
    EditGoalComponent.prototype.createTheUniqueArray = function () {
        this.uniqueArray = [];
        var length = this.reminderValues.length;
        for (var i = 0; i < length; i++) {
            var tmp = this.reminderValues[i];
            if (tmp !== '') {
    ...
    EditGoalComponent.prototype.remindersToString = function () {
        this.reminderString = this.uniqueArray.join(',').trim();
    };
    EditGoalComponent.prototype.stringToReminders = function () {
        this.reminderValues = this.reminderString.split(',');
        var len = this.reminderValues.length;
        for (var i = 0; i < len; i++) {
            var tmp = this.reminderValues[i];
            if (tmp.indexOf(':') < 0) {
    ...
    EditGoalComponent.prototype.checkNumber = function (obj) {
        if (obj < 1) {
            alert('The field for "Number of events" cannot be low than 1');
            this.goal.end_date.number_of_event = 1;
        }
    };
    EditGoalComponent.prototype.checkNumber1 = function (obj) {
        if (obj < 1) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__user_user_service__ = __webpack_require__(56);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_common_functions__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__user_user_service__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_common_functions__ = __webpack_require__(19);
...
var ResetPasswordComponent = (function () {
    ...
    ResetPasswordComponent.prototype.updateMatch = function () {
...
var Goal = (function () {
    function Goal(email, token, goal_name, start_date, description, repetition, end_date, is_auto, time_before) {
        this.email = email;
        this.token = token;
    ...
    SignUpComponent.prototype.doSignUp = function (event) {
        ...
        if (user.password != user.password_confirmation) {
            ...
            this.userService.signUp(user.name, user.email, user.password).subscribe(function (res) {
                ...
                _this.ready();
                var errorDisplay = JSON.parse(error['_body']);
...
var YearViewComponent = (function () {
    ...
    YearViewComponent.prototype.nextYear = function () {
        ...
        this.goalService.getGoalsById(this.id).toPromise().then(function (data) {
            _this.goal = JSON.parse(data['_body']);
            _this.isDataLoaded = true;
            _this.router.navigate(['/yearview', _this.id, _this.year]);
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app___ = __webpack_require__(508);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__active_account_active_account_component__ = __webpack_require__(327);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__forgot_password_forgot_password_component__ = __webpack_require__(333);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__reset_password_reset_password_component__ = __webpack_require__(338);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__year_view_month_in_year_view_component__ = __webpack_require__(510);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__year_view_year_view_component__ = __webpack_require__(342);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__edit_goal_edit_goal_component__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__angular_platform_browser__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__angular_common__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__angular_forms__ = __webpack_require__(128);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__angular_http__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__angular_router__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__app_component__ = __webpack_require__(328);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__create_new_goal_create_new_goal_component__ = __webpack_require__(330);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__detail_view_detail_view_component__ = __webpack_require__(331);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__introduction_introduction_component__ = __webpack_require__(334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__login_login_component__ = __webpack_require__(336);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__app_route__ = __webpack_require__(503);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__sign_up_sign_up_component__ = __webpack_require__(341);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__side_bar_side_bar_component__ = __webpack_require__(509);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__shared_logged_in_guard__ = __webpack_require__(142);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__archived_goals_archived_goals_module__ = __webpack_require__(504);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__goal_goal_service__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__user_user_service__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__detail_view_detail_view_module__ = __webpack_require__(506);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__page_not_found_page_not_found_component__ = __webpack_require__(337);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__archived_goals_archived_goals_component__ = __webpack_require__(329);
    ...
    AppModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_15__introduction_introduction_component__["a" /* IntroductionComponent */],
                ...
                __WEBPACK_IMPORTED_MODULE_19__side_bar_side_bar_component__["a" /* SideBarComponent */],
                __WEBPACK_IMPORTED_MODULE_13__create_new_goal_create_new_goal_component__["a" /* CreateNewGoalComponent */],
                __WEBPACK_IMPORTED_MODULE_14__detail_view_detail_view_component__["a" /* DetailViewComponent */],
                __WEBPACK_IMPORTED_MODULE_5__edit_goal_edit_goal_component__["a" /* EditGoalComponent */],
                __WEBPACK_IMPORTED_MODULE_4__year_view_year_view_component__["a" /* YearViewComponent */],
                __WEBPACK_IMPORTED_MODULE_25__page_not_found_page_not_found_component__["a" /* PageNotFoundComponent */],
                __WEBPACK_IMPORTED_MODULE_3__year_view_month_in_year_view_component__["a" /* MonthInYearComponent */],
                __WEBPACK_IMPORTED_MODULE_26__archived_goals_archived_goals_component__["a" /* ArchivedGoalsComponent */],
                __WEBPACK_IMPORTED_MODULE_2__reset_password_reset_password_component__["a" /* ResetPasswordComponent */],
                __WEBPACK_IMPORTED_MODULE_1__forgot_password_forgot_password_component__["a" /* ForgotPasswordComponent */],
                __WEBPACK_IMPORTED_MODULE_0__active_account_active_account_component__["a" /* ActiveAccountComponent */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_21__archived_goals_archived_goals_module__["a" /* ArchivedGoalsModule */],
                __WEBPACK_IMPORTED_MODULE_24__detail_view_detail_view_module__["a" /* DetailViewModule */],
                ...
                __WEBPACK_IMPORTED_MODULE_10__angular_http__["e" /* HttpModule */],
                __WEBPACK_IMPORTED_MODULE_9__angular_forms__["e" /* ReactiveFormsModule */],
                __WEBPACK_IMPORTED_MODULE_11__angular_router__["c" /* RouterModule */].forRoot(__WEBPACK_IMPORTED_MODULE_17__app_route__["a" /* appRoutes */])
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_23__user_user_service__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_20__shared_logged_in_guard__["a" /* LoggedInGuard */], __WEBPACK_IMPORTED_MODULE_22__goal_goal_service__["a" /* GoalService */],
                { provide: __WEBPACK_IMPORTED_MODULE_8__angular_common__["c" /* LocationStrategy */], useClass: __WEBPACK_IMPORTED_MODULE_8__angular_common__["e" /* HashLocationStrategy */] }],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__forgot_password_forgot_password_component__ = __webpack_require__(333);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__reset_password_reset_password_component__ = __webpack_require__(338);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__year_view_year_view_component__ = __webpack_require__(342);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__edit_goal_edit_goal_component__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__archived_goals_archived_goals_component__ = __webpack_require__(329);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__create_new_goal_create_new_goal_component__ = __webpack_require__(330);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__detail_view_detail_view_component__ = __webpack_require__(331);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__introduction_introduction_component__ = __webpack_require__(334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__loading_indicator_loading_indicator_component__ = __webpack_require__(335);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__login_login_component__ = __webpack_require__(336);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__shared_logged_in_guard__ = __webpack_require__(142);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__page_not_found_page_not_found_component__ = __webpack_require__(337);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__sign_up_sign_up_component__ = __webpack_require__(341);
...
var appRoutes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_8__introduction_introduction_component__["a" /* IntroductionComponent */], pathMatch: 'full' },
    { path: 'login', component: __WEBPACK_IMPORTED_MODULE_10__login_login_component__["a" /* LoginComponent */] },
    { path: 'signup', component: __WEBPACK_IMPORTED_MODULE_13__sign_up_sign_up_component__["a" /* SignUpComponent */] },
    { path: 'createnewgoal', component: __WEBPACK_IMPORTED_MODULE_6__create_new_goal_create_new_goal_component__["a" /* CreateNewGoalComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_11__shared_logged_in_guard__["a" /* LoggedInGuard */]] },
    { path: 'detailview', component: __WEBPACK_IMPORTED_MODULE_7__detail_view_detail_view_component__["a" /* DetailViewComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_11__shared_logged_in_guard__["a" /* LoggedInGuard */]] },
    { path: 'archivedgoals', component: __WEBPACK_IMPORTED_MODULE_5__archived_goals_archived_goals_component__["a" /* ArchivedGoalsComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_11__shared_logged_in_guard__["a" /* LoggedInGuard */]] },
    { path: 'loading', component: __WEBPACK_IMPORTED_MODULE_9__loading_indicator_loading_indicator_component__["a" /* LoadingIndicatorComponent */] },
    { path: 'editgoal/:id', component: __WEBPACK_IMPORTED_MODULE_4__edit_goal_edit_goal_component__["a" /* EditGoalComponent */], CanActivate: [__WEBPACK_IMPORTED_MODULE_11__shared_logged_in_guard__["a" /* LoggedInGuard */]] },
    { path: 'yearview/:id/:year', component: __WEBPACK_IMPORTED_MODULE_3__year_view_year_view_component__["a" /* YearViewComponent */], CanActivate: [__WEBPACK_IMPORTED_MODULE_11__shared_logged_in_guard__["a" /* LoggedInGuard */]] },
    { path: 'resetpassword/:token', component: __WEBPACK_IMPORTED_MODULE_2__reset_password_reset_password_component__["a" /* ResetPasswordComponent */] },
    { path: 'activeaccount/:token', component: __WEBPACK_IMPORTED_MODULE_0__active_account_active_account_component__["a" /* ActiveAccountComponent */] },
    { path: 'forgotpassword', component: __WEBPACK_IMPORTED_MODULE_1__forgot_password_forgot_password_component__["a" /* ForgotPasswordComponent */] },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__archived_goals_route__ = __webpack_require__(505);
...
var archivedGoalsRoutes = [
    { path: 'monthview/:id/:year/:month', component: __WEBPACK_IMPORTED_MODULE_1__month_view_month_view_component__["a" /* MonthViewComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_0__shared_logged_in_guard__["a" /* LoggedInGuard */]] }
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__loading_indicator_loading_indicator_component__ = __webpack_require__(335);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__detail_view_route__ = __webpack_require__(507);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_goal__ = __webpack_require__(339);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__(0);
...
var MonthInYearComponent = (function () {
    function MonthInYearComponent(goalService, router) {
        this.goalService = goalService;
        this.router = router;
    ...
    MonthInYearComponent.prototype.onClickLi = function (obj) {
        ...
        var id = this.goalInMonth.id;
        var strDate = date.toString();
        var status = this.state[obj].toString();
        clearTimeout(this.myTimeOut[obj]);
        this.myTimeOut[obj] = window.setTimeout((function () {
            _this.goalService.markGoal(id, strDate, status).toPromise().then(function () { return; });
        }), 1000);
    };
    MonthInYearComponent.prototype.showMonthView = function () {
    ...
    MonthInYearComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__goal_goal_service__["a" /* GoalService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_0__goal_goal_service__["a" /* GoalService */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */]) === 'function' && _c) || Object])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_headers__ = __webpack_require__(340);
...
module.exports = ".form-group {\n  width: 40%;\n  margin: 0 auto;\n  position: relative; }\n  .form-group h2 {\n    font-size: 26px;\n    font-weight: 600;\n    text-align: left;\n    color: #1E824C;\n    border-bottom: 1px solid #1E824C;\n    padding-bottom: 3px;\n    margin-bottom: 20px; }\n  .form-group a {\n    font-size: inherit;\n    font-family: inherit;\n    color: #1E824C;\n    text-decoration: none;\n    -webkit-transition: all 1s ease-out;\n    transition: all 1s ease-out; }\n    .form-group a:hover {\n      text-decoration: underline;\n      color: #28ab64; }\n    .form-group a:active {\n      color: #95A5A6; }\n  .form-group label {\n    font-size: 12.5px;\n    color: #1E824C;\n    display: block;\n    font-weight: 500;\n    margin-bottom: 0.5em;\n    margin-top: 1em;\n    margin-left: 1em; }\n  .form-group input[type=\"email\"],\n  .form-group input[type=\"password\"],\n  .form-group input[type=\"text\"] {\n    font-family: inherit;\n    font-size: inherit;\n    color: #222;\n    border: 1px solid #1E824C;\n    border-radius: 10px;\n    height: 25px;\n    padding: 0.2em;\n    width: 100%;\n    -webkit-transition: all 0.2s;\n    transition: all 0.2s;\n    box-sizing: content-box; }\n    .form-group input[type=\"email\"]:focus, .form-group input[type=\"email\"]:hover,\n    .form-group input[type=\"password\"]:focus,\n    .form-group input[type=\"password\"]:hover,\n    .form-group input[type=\"text\"]:focus,\n    .form-group input[type=\"text\"]:hover {\n      outline: none;\n      box-shadow: 0 0 5px 0 #86E2D5; }\n  .form-group div {\n    color: #1E824C;\n    font-size: 12.5px; }\n  .form-group button {\n    border: 1px solid white;\n    border-radius: 10px;\n    background-color: #1E824C;\n    color: white;\n    font-family: inherit;\n    font-size: inherit;\n    padding: 0.5em;\n    width: 101%;\n    margin-top: 2em;\n    -webkit-transition: all 0.3s;\n    transition: all 0.3s;\n    cursor: pointer; }\n    .form-group button:active, .form-group button:focus, .form-group button:hover {\n      outline: none;\n      background-color: white;\n      color: #1E824C;\n      font-weight: bold;\n      border: 1.5px solid #1E824C; }\n  .form-group span {\n    position: absolute;\n    color: #aaa;\n    cursor: pointer; }\n    .form-group span.a {\n      top: 70%;\n      left: 95%; }\n    .form-group span.b {\n      top: 91.5%;\n      left: 95%; }\n    .form-group span.match1 {\n      top: 59%;\n      left: 95%; }\n    .form-group span.match2 {\n      top: 78.5%;\n      left: 95%; }\n  .form-group .alert1 {\n    width: 30%;\n    color: #D80027;\n    border: 1px solid #D80027;\n    border-radius: 10px;\n    padding: 0.5em;\n    margin: 2em 35% 0; }\n    .form-group .alert1 b {\n      margin: 0 1.6em; }\n\n@media screen and (min-width: 1920px) {\n  .form-group button {\n    width: 101.5%; }\n  .form-group span.a {\n    top: 70%;\n    left: 97%; }\n  .form-group span.b {\n    top: 91.5%;\n    left: 97%; }\n  .form-group span.match1 {\n    top: 59%;\n    left: 97%; }\n  .form-group span.match2 {\n    top: 78.5%;\n    left: 97%; } }\n\n@media screen and (max-width: 1919px) and (min-width: 1366px) {\n  .form-group button {\n    width: 102%; }\n  .form-group .alert1 {\n    width: 41%;\n    margin: 2em 31% 0; } }\n\n@media screen and (max-width: 1322px) and (min-width: 768px) {\n  .form-group {\n    width: 70%; }\n    .form-group button {\n      width: 102%; }\n    .form-group .alert1 {\n      width: 50%;\n      margin: 2em 26% 0; }\n    .form-group span.match1 {\n      top: 59%;\n      left: 97%; }\n    .form-group span.match2 {\n      top: 78.5%;\n      left: 97%; } }\n\n@media screen and (max-width: 767px) and (min-width: 375px) {\n  .form-group {\n    width: 95%; }\n    .form-group button {\n      width: 104%; }\n    .form-group span {\n      display: none; }\n    .form-group .alert1 {\n      width: 103%;\n      margin: 2em 0 0; }\n      .form-group .alert1 b {\n        margin: 0 0.5em; } }\n"
...
module.exports = "<app-loading-indicator></app-loading-indicator>"
...
module.exports = "<div class=\"introduction\">\n    <div class=\"welcome\" [hidden]=\"currentUser != null\">\n        <img src=\"../../assets/img/welcome.png\" class=\"iphone\" alt=\"welcome\" width=\"120px\" style=\"vertical-align: middle; float: right;\" hidden=\"hidden\">\n        <p>\n            Hello guest! How are you today? Ready to <a routerLink=\"/createnewgoal\">challenge</a> yourself?\n        </p>\n        <img src=\"../../assets/img/welcome.png\" alt=\"welcome\" width=\"120px\" style=\"vertical-align: middle; float: right;\">\n        <div class=\"clear\"></div>\n        <hr style=\"float: right;\" />\n    </div>\n    <div class=\"info\" [hidden]=\"currentUser != null\">\n        <img src=\"../../assets/img/calendar.png\" alt=\"calendar\" width=\"120px\" style=\"vertical-align: middle;\">\n        <p>\n            Seinfeld Calendar is an awesome app which assists you to set your goals and tracking their progresses.\n            <a routerLink=\"/signup\">Create a new account</a> or <a routerLink=\"/login\">sign in</a> to start using it.\n        </p>\n        <div class=\"clear\"></div>\n        <hr />\n    </div>\n    <!-- [hidden]=\"currentUser == null\" -->\n    <div class=\"logged-in\" [hidden]=\"currentUser == null\">\n        <img src=\"../../assets/img/run.png\" alt=\"start\" width=\"120px\" style=\"vertical-align: middle;\">\n        <p>\n            Hi <b>{{currentUser != null ? currentUser.name : \"\"}}</b>! Check your <a routerLink=\"/detailview\">dashboard</a> or challenge yourself with <a routerLink=\"/createnewgoal\">new goal</a>!\n        </p>\n        <div class=\"clear\"></div>\n        <hr />\n    </div>\n</div>\n"
...
module.exports = "<div class=\"page-not-found\">\n  <div class=\"img\"><img src=\"../../assets/img/not_found.svg\" alt=\"File not found\" height=\"200px\" width=\"200px\"></div>\n  <div class=\"content\">\n    <p>\n      Opps! We could not find this page. Please return to our <a routerLink=\"/\">home page</a> and enjoy our awesome application!\n    </p>\n  </div>\n</div>\n"
...
module.exports = "<div [ngSwitch]=\"loading\">\n    <div *ngSwitchCase=\"'loading'\"><app-loading-indicator></app-loading-indicator></div>\n    <div *ngSwitchCase=\"'loaded'\">\n        <form [formGroup]=\"signUpForm\" (ngSubmit)=\"doSignUp()\" *ngIf=\"!submitted\">\n            <!--  General -->\n            <div class=\"form-group\">\n                <h2 class=\"heading\">Sign up</h2>\n                <label for=\"name\">Name</label>\n                <input formControlName=\"name\" type=\"text\" id=\"name\" name=\"name\" required>\n                <label for=\"email\">Email</label>\n                <input formControlName=\"email\" type=\"email\" id=\"email\" name=\"email\" required pattern=\"[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$\">\n                <label for=\"password\">Password</label>\n                <!-- pattern=\"^(?=.*[A-Za-z])(?=.*\\d)[A-Za-z\\d]{8,}$\" -->\n                <input formControlName=\"password\" type=\"password\" id=\"password\"  name=\"password\" required minlength='6'>\n                <span class=\"fa fa-eye-slash a\" [class.match1]=\"isPasswordNotMatch\" (mouseover)=\"displayPassword('password')\" (mouseleave)=\"displayPassword('password')\"></span>\n                <label for=\"password_confirmation\">Confirm Password</label>\n                <input formControlName=\"password_confirmation\" type=\"password\" id=\"password_confirmation\" class=\"floatLabel\" name=\"password_confirmation\" data-toggle=\"tooltip\"\n                    data-placement=\"right\" title=\"Password does not match!\" required minlength=\"6\">\n                <span class=\"fa fa-eye-slash b\" [class.match2]=\"isPasswordNotMatch\" (mouseover)=\"displayPassword('password_confirmation')\" (mouseleave)=\"displayPassword('password_confirmation')\"></span>\n                <div class=\"alert1\" id=\"password-match\" [hidden]=\"!isPasswordNotMatch\">\n                    <b>Passwords do not match</b>\n                </div>\n            </div>\n            <!-- button -->\n            <div class=\"form-group\">\n                <button type=\"submit\">Create free account</button>\n            </div>\n        </form>\n        <form *ngIf=\"submitted\">\n            <!--  General -->\n            <div class=\"form-group\">\n                <h2 class=\"heading\">Please Verify Your Email.</h2>\n                <p class=\"announce\">\n                Congratulation! An email contains the link to verify your email has been sent to the email <b><i>{{email}}</i></b>.\n                Please follow the instructions in that email to finish your registration.\n                </p>\n            </div>\n        </form>\n    </div>\n</div>\n"
